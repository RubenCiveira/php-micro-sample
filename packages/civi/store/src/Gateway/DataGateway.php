...
class DataGateway
{
    ...
    public function read(string $namespace, string $typeName, DataQueryParam $filters): array
    {
    ...
    public function save(string $namespace, string $typeName, string $id, array $data)
    {
        $path = "{$this->baseDir}/$namespace/$typeName/";
        if (!is_dir($path)) {
    ...
    public function delete(string $namespace, string $typeName, array $read, string $idName): void
    {
        $path = "{$this->baseDir}/$namespace/$typeName/";
        if (is_dir($path)) {
