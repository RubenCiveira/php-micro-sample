...
class SchemaBuilder
{
    public static function generateSchemaFromType(ObjectType $type, string $group, string $fqn, string $filePath): void
    {
        ...
        $className = $type->name() . 'EntitySchemaBuilder';
        $entityShort = array_slice(explode('\\', $fqn), -1)[0];
        $namespace = implode('\\', array_slice(explode('\\', $fqn), 0, -1)) . '\\Schema';
        ...
        $buildMethod = new Node\Stmt\ClassMethod('build', [
            ...
            'returnType' => new Node\Name('TypeSchemaBuilder')
        ], [
        ...
        $repositoryProperty = new Node\Stmt\Property(
            ...
            attrGroups: [],
            type: new Node\Name('EntitySchemaBuilder')
        );
        ...
        $uses = [
            ...
            new Node\Stmt\Use_([
                new Node\Stmt\UseUse(new Node\Name('Civi\Micro\Schema\TypeSchemaBuilder')),
            ]),
            new Node\Stmt\Use_([
                new Node\Stmt\UseUse(new Node\Name('Civi\Store\EntitySchemaBuilder')),
            ]),
            new Node\Stmt\Use_([
