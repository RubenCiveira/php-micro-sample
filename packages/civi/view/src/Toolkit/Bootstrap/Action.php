...
class Action
{
    ...
    public function __construct(private readonly string $target, private readonly TypeSchema $meta, private readonly ActionSchema $action) 
    {
    ...
    public function render(): string
    {
        ...
        } else if( $this->action->fields  ?? false ) {
            $form = new Form($this->action->name, $this->target, $this->meta, $this->action->fields);
            $body .= $form->render();
